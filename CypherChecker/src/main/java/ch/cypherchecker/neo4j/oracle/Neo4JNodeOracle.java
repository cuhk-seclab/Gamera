...
public class Neo4JNodeOracle extends CypherNodeOracle<Neo4JConnection, Neo4JType> {

    private final ExpectedErrors errors = new ExpectedErrors();

    public Neo4JNodeOracle(GlobalState<Neo4JConnection> state, Schema<Neo4JType> schema) {
        super(state, schema);
