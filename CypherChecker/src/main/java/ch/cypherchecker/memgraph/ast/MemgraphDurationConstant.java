...
public class MemgraphDurationConstant extends CypherConstant {

    private String value;
    private Map<String, Long> datePart;
    private Map<String, Long> timePart;

    public MemgraphDurationConstant(Map<String, Long> datePart, Map<String, Long> timePart) {
    ...
    public MemgraphDurationConstant(String value) {
        this.value = value;
    }
