package ch.cypherchecker.neo4j.ast;

import ch.cypherchecker.common.schema.Entity;
import ch.cypherchecker.cypher.ast.*;
import ch.cypherchecker.cypher.ast.CypherBinaryArithmeticOperation.ArithmeticOperator;
...
public class Neo4JExpressionGenerator {
    ...
    private CypherExpression generateBooleanExpression(int depth) {
        ...
        switch (option) {
            ...
            case BINARY_COMPARISON:
                if (Neo4JBugs.PartitionOracleSpecific.bug5) {
    ...
    */
    ...
    // Get filteredVariables from specified type
