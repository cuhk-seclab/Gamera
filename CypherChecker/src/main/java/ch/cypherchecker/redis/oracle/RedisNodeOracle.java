...
public class RedisNodeOracle extends CypherNodeOracle<RedisConnection, RedisType> {

    private final ExpectedErrors errors = new ExpectedErrors();

    public RedisNodeOracle(GlobalState<RedisConnection> state, Schema<RedisType> schema) {
        super(state, schema);
