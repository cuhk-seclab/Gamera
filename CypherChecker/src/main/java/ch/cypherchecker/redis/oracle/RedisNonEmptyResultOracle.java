...
import ch.cypherchecker.cypher.oracle.CypherNonEmptyResultOracle;
...
public class RedisNonEmptyResultOracle extends CypherNonEmptyResultOracle<RedisConnection, RedisType> {

    public RedisNonEmptyResultOracle(GlobalState<RedisConnection> state, Schema<RedisType> schema) {
        super(state, schema);
    }
