...
public class RedisEdgeOracle extends CypherEdgeOracle<RedisConnection, RedisType> {

    private final ExpectedErrors errors = new ExpectedErrors();

    public RedisEdgeOracle(GlobalState<RedisConnection> state, Schema<RedisType> schema) {
        super(state, schema);
